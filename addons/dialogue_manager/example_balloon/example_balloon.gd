...
onready var character_label := $Balloon/Margin/HBoxContainer/VBox/Character
onready var dialogue_label := $Balloon/Margin/HBoxContainer/VBox/Dialogue
onready var responses_menu := $Balloon/Margin/HBoxContainer/VBox/Responses
onready var response_template := $Balloon/Margin/HBoxContainer/VBox/ResponseTemplate
...
func _ready() -> void:
	print("got dialogue line", dialogue_line)
	...
	print("hmmmm", dialogue_label.dialogue_line)
