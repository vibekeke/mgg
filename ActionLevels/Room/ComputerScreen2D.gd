...
func fade_in_desktop():
	desktop_background.modulate = Color(0.0, 0.0, 0.0, 1.0)
	computer_tween.interpolate_property(desktop_background, "modulate", desktop_background.modulate, Color(1.0,1.0,1.0,1.0), 2.0, Tween.TRANS_LINEAR, Tween.EASE_IN_OUT)
	computer_tween.start()
