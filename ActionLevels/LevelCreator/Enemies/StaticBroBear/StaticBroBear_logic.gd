...
func _fire_again_timer_setup():
	...
	fire_again_timer.connect("timeout", Callable(self, "_on_fire_again_timeout"))
...
func _on_fire_rate_timeout():
	...
	for bullet in get_tree().get_nodes_in_group("static_bro_bear_bullets"):
		var new_bullet = bro_bear_bullet.instantiate()
...
func _setup_bullets():
	...
	for i in range(spawn_point_count):
		var spawn_point = bro_bear_bullet.instantiate()
